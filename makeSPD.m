...
width=162; %width of region in angstroms

%based on width we need to calculate distance necessary to produce
%equivalent interfaces

width1=width-mod(width,6^(1/2)*a01/2)+0.1; 
width2=width-mod(width,6^(1/2)*a02)+0.1; 
disp('width1'); 
disp(width1); 
disp('width2'); 
disp(width2); 
