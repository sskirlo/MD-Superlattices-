...
a=sprintf('in.CuNb_KS2fullmin%s',str); 
...
a=sprintf('read_data       CuNb_KS2p%s.data \n',str);
fprintf(fp,a);     
a=sprintf('write_restart   cunbks2p%s.restart \n',str); 
fprintf(fp,a);
...
%open restart file
fprintf(fp,'units           metal \n');
a=sprintf('read_restart    cunbks2p%s.restart \n',str); 
fprintf(fp,a);
...
a=sprintf('write_restart KS2pmined%s.restart \n',str);
fprintf(fp,a);  
fprintf(fp,'reset_timestep 1 \n'); 
a=sprintf('dump ohsnap all cfg 1 cunb_KS2pmined%s*.dump id type xs ys zs id c_kea c_pea c_stress[1] c_stress[2] c_stress[3] c_stress[4] c_stress[5] c_stress[6] \n',str);
fprintf(fp,a);  
